...
function Page() {
  return (
    ...
    bg-cover  flex flex-col'>
      ...
      <h1 className='sm:text-5xl sm:px-0 px-4 leading-10 text-3xl text-purple-50 font-bold tracking-widest text-center pt-16 pb-4 '>Welcome To UI Color Universe</h1>
      <p className='text-2xl text-purple-50 font-semibold tracking-wider text-center sm:w-[50vw] w-[95vw] mx-auto'> Innovation meets aesthetics. Immerse yourself in an impressive UI color picker experience. Sign up now and the spectrum of creativity at your fingertips!</p>
